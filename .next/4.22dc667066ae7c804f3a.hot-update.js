...
function (_React$Component) {
  ...
  function ChatContainer(props) {
    ...
    _this = _possibleConstructorReturn(this, (ChatContainer.__proto__ || Object.getPrototypeOf(ChatContainer)).call(this, props)); // Change this to ab object
  ...
  _createClass(ChatContainer, [{
    ...
    value: function onSubmit(data) {
      // console.log(data)
      this.setState({
        messages: _toConsumableArray(this.state.data).concat([data])
      });
    }
  }, {
    key: "render",
...
//# sourceMappingURL=4.22dc667066ae7c804f3a.hot-update.js.map